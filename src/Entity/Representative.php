...
class Representative implements JsonSerializable, FeaturedImageInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Category", inversedBy="representatives")
     */
    private $categories;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UniqueLink", mappedBy="representative", orphanRemoval=true)
     */
    private $uniqueLinks;
    ...
    public function addUniqueLink(UniqueLink $uniqueLink): self
    {
        if (!$this->uniqueLinks->contains($uniqueLink)) {
            ...
            $uniqueLink->setRepresentative($this);
        }
    ...
    public function removeUniqueLink(UniqueLink $uniqueLink): self
    {
        if ($this->uniqueLinks->contains($uniqueLink)) {
            ...
            // set the owning side to null (unless already changed)
            if ($uniqueLink->getRepresentative() === $this) {
                $uniqueLink->setRepresentative(null);
            }
        }
